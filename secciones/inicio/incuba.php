<section id="incuba" class="paralax-bg section columns h-100-v p-top">
  ...
  <div class="content-wrapper">
    ...
    <div class="columns h-15 v-center">
      ...
      <h1 class="columns p-0 text-left color-blanco">Incuba</h1>
    ...
    <div class="columns h-85 v-center">
      ...
      <div class="columns p-0 small-8 medium-6 large-4 h-50 small-centered v-center">
        ...
        <object id="incuba-svg" class="columns p-0 h-100" type="image/svg+xml" data="<?php echo get_stylesheet_directory_uri();?>/img/inicio-svgs/test.svg"></object>

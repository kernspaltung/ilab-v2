<section id="inicio-startups" class="paralax-bg section columns h-100-v p-top">
  <?php
  $args = page_id(32);
  ...
  <div class="content-wrapper">
      ...
      <div class="columns h-85 v-center">
        ...
        <div class="columns p-0 small-8 medium-6 large-4 h-50 small-centered v-center">
          ...
          <!-- svg animado -->
          <object id="nosotros-svg" class="columns p-0 h-100 text-shadow" type="image/svg+xml" data="<?php echo get_stylesheet_directory_uri();?>/img/inicio-svgs/test3.svg"></object>
        ...
        <div class="columns p-0 small-11 medium-9 large-7 small-centered h-50 rel v-center">
          ...
          <a href="<?php echo get_page_link(18);?>" class="link-seccion button columns small-8 medium-6 large-4 h-a p-1 m-t-0-2 font-s font-sm-m font-lg-l absDownR shadow">

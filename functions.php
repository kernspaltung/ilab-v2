...
function recursos() {
  ...
  wp_enqueue_style( 'slick-css', get_stylesheet_directory_uri() . '/bower_components/fullpage.js/dist/jquery.fullpage.css');
  ...
  wp_enqueue_style( 'google-fonts', 'https://fonts.googleapis.com/css?family=Raleway|Rubik');
  //
  ...
  wp_enqueue_script( 'slick-carousel', get_stylesheet_directory_uri() .'/bower_components/slick-carousel/slick/slick.min.js', array('jquery') );
  wp_enqueue_script( 'imgLiquid', get_stylesheet_directory_uri() . '/bower_components/imgLiquid/js/imgLiquid-min.js', array('jquery') );
  wp_enqueue_script( 'imgLiquid', get_stylesheet_directory_uri() . '/bower_components/vivus/dist/vivus.js', array('jquery') );
  wp_enqueue_script( 'js_utils', get_stylesheet_directory_uri() . '/submodulos/js_utils/dist/js/js_utils.min.js', array('jquery') );
  wp_enqueue_script( 'scrolltrip-js', get_stylesheet_directory_uri() . '/submodulos/scroll-trip.js/js/app.js', array('jquery') );
  wp_enqueue_script( 'app-master', get_stylesheet_directory_uri() . '/js/app.js', array('jquery') );

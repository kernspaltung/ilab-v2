  ...
  <div class="content-wrapper">
      ...
      <div class="columns h-85 v-center">
        ...
        <div class="columns p-0 small-8 medium-6 large-4 h-50 small-centered v-center">
          ...
          <!-- svg animado -->
          <object id="startups-svg" class="columns p-0 h-100 text-shadow" type="image/svg+xml" data="<?php echo get_stylesheet_directory_uri();?>/img/inicio-svgs/test3.svg"></object>

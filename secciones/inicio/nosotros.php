<section id="nosotros" class="paralax-bg section columns h-100-v p-top rel">
...
<div class="content-wrapper">
  ...
  <div class="columns h-15 v-center">
    ...
    <h1 class="columns p-0 text-left">¿Qué es ILab?</h1>
  ...
  <div class="columns h-85 v-center">
    ...
    <div class="columns p-0 small-8 medium-6 large-4 h-50 small-centered v-center">
      ...
      <object id="nosotros-svg" class="columns p-0 h-100" type="image/svg+xml" data="img/inicio-svgs/test.svg"></object>

    </div>

    <!--  -->
    <div class="columns p-0 small-11 medium-9 large-7 h-50 small-centered v-center">
